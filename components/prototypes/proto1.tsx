                    ...
                    page1ButtonPoses.forEach((pos, idx) => {
                        switch (idx) {
                            ...
                            case 8:
                                ...
                                break;
                            default:
                                let option = letterBank[idx];
                                p5.stroke(0); 
                                p5.strokeWeight(.5);
                                p5.fill(240);
                                p5.rect(pos[0], pos[1], pos[2], pos[3]);

                                if (option.length > 0) { // insert newline in the middle of the string
                                    if(option.length > 3) option = option.substring(0, 3) + "\n" + option.substring(3);
                                    p5.strokeWeight(0);
                                    p5.textAlign(p5.CENTER, p5.CENTER);
                                    p5.fill(0);
                                    p5.text(option, pos[0], pos[1], pos[2], pos[3]);
                                }
                                break;
                        }
                    });
